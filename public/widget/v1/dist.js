(function () {
    ...
    function add_css(target) {
    	append_styles(target, "svelte-v3pxcq", ":root{font-family:Arial, Helvetica, sans-serif}main.svelte-v3pxcq.svelte-v3pxcq{position:fixed;z-index:2147483647;right:var(--offsetX);bottom:var(--offsetY);display:flex;flex-direction:column;gap:16px;align-items:flex-end}.chat.svelte-v3pxcq.svelte-v3pxcq{height:calc(100vh - var(--offsetY) - 100px);width:400px;background-color:white;border-radius:12px;overflow:hidden;display:flex;flex-direction:column;justify-content:flex-end}.button.svelte-v3pxcq.svelte-v3pxcq{height:72px;width:72px;border-radius:100%;background-color:#3478ff;display:flex;align-items:center;justify-content:center}.button.svelte-v3pxcq img.svelte-v3pxcq{position:absolute;height:44px}.shadow.svelte-v3pxcq.svelte-v3pxcq{box-shadow:0px 4px 12px rgba(35, 57, 90, 0.15)}.indicator.svelte-v3pxcq.svelte-v3pxcq{height:10px;width:10px;border-radius:100%;background-color:#4bff2e;border:solid #3478ff 3px;position:absolute;bottom:5px;right:5px}.text-field.svelte-v3pxcq.svelte-v3pxcq{background-color:white;height:72px;box-shadow:0px -4px 12px rgba(35, 57, 90, 0.1)}.text-field.svelte-v3pxcq div.svelte-v3pxcq{display:flex;align-items:center;padding:4px 16px 0px 16px;gap:16px}.text-field.svelte-v3pxcq input.svelte-v3pxcq{border:none;flex-grow:1;font-size:medium;padding:6px 4px}.text-field.svelte-v3pxcq input.svelte-v3pxcq:focus{outline:none}.text-field.svelte-v3pxcq button.svelte-v3pxcq{border:none;height:48px;width:48px;border-radius:12px;background:url(\"https://pointai.tech/widget/assets/send.svg\") no-repeat\n\t\t\tcenter;transition:100ms ease-in-out}.text-field.svelte-v3pxcq button.svelte-v3pxcq:active{transform:scale(0.9);background-color:#e5e5e5}.appbar.svelte-v3pxcq.svelte-v3pxcq{background:url(\"https://pointai.tech/widget/assets/gradient.svg\")\n\t\t\tno-repeat center/cover;transition:300ms ease-in-out;height:72px;display:flex;flex-direction:column;align-items:start;justify-content:center;color:white}.appbar-open.svelte-v3pxcq.svelte-v3pxcq{height:calc(100% - 72px);align-items:center}.appbar.svelte-v3pxcq>.title.svelte-v3pxcq{font-size:x-large;margin:12px 0px 0px 0px}.appbar.svelte-v3pxcq>.subtitle.svelte-v3pxcq{font-size:medium;font-weight:200;margin:4px 0px 0px 0px;text-align:center}.content.svelte-v3pxcq.svelte-v3pxcq{background-color:white;max-height:calc(100% - 144px);flex-grow:1;overflow-y:scroll;display:flex;flex-direction:column-reverse;padding:0px 16px;font-size:medium;line-height:1.3}.message.svelte-v3pxcq.svelte-v3pxcq{padding:16px;margin:4px 0px;border-radius:16px;max-width:60%}.message-user.svelte-v3pxcq.svelte-v3pxcq{align-self:flex-end;background-color:#3478ff;color:white;border-end-end-radius:4px}.message-bot.svelte-v3pxcq.svelte-v3pxcq{align-self:flex-start;background-color:#edf3fe;color:#1b2c45;border-end-start-radius:4px}.avatar-wrapper.svelte-v3pxcq.svelte-v3pxcq{display:flex;flex-direction:row;margin:0px 16px;gap:12px}.avatar-title-closed.svelte-v3pxcq.svelte-v3pxcq{display:flex;flex-direction:column;justify-content:center}.avatar-title-closed.svelte-v3pxcq>p.svelte-v3pxcq{margin:0}.avatar-subtitle.svelte-v3pxcq.svelte-v3pxcq{font-size:smaller;opacity:0.5}.avatar.svelte-v3pxcq.svelte-v3pxcq{height:48px;width:48px;border-radius:50%;background:url(\"https://pointai.tech/widget/assets/avatar.png\")\n\t\t\tno-repeat center;background-size:60%;border:solid 2px white}.avatar.svelte-v3pxcq.svelte-v3pxcq::after{content:\"\";height:9px;width:9px;display:block;border-radius:50%;background-color:#4bff2e;margin-left:35px;margin-top:35px;border:solid #3478ff 2.5px}.language-picker.svelte-v3pxcq.svelte-v3pxcq{position:absolute;top:12px;right:12px;transition:300ms ease-in-out}.language-select.svelte-v3pxcq.svelte-v3pxcq{margin-top:60px;border-radius:12px;background-color:white;box-shadow:0px 4px 12px rgba(35, 57, 90, 0.15);color:#1b2c45;transition:scale 100ms ease-in-out;padding:4px;transform-origin:top right}.language-picker.svelte-v3pxcq>.language-select.svelte-v3pxcq{scale:0}.language-picker.svelte-v3pxcq:hover>.language-select.svelte-v3pxcq{scale:1}.selected-language.svelte-v3pxcq.svelte-v3pxcq{background-color:#7ea9ff;border-radius:12px;padding:8px 12px;font-size:24px;float:right}.language-select.svelte-v3pxcq>div.svelte-v3pxcq{padding:12px 20px;word-spacing:4px;border-radius:10px;cursor:pointer}.language-select.svelte-v3pxcq>div.svelte-v3pxcq:hover{background-color:#e5e5e5}.greeting.svelte-v3pxcq.svelte-v3pxcq{position:fixed;box-sizing:border-box;bottom:calc(var(--offsetY) + 5px);right:calc(var(--offsetX) + 80px);background-color:white;border:solid #3478ff 3px;padding:12px;border-radius:12px 12px 4px 12px}.greeting.svelte-v3pxcq p.svelte-v3pxcq{margin:0px;font-size:14px}.greeting.svelte-v3pxcq p.svelte-v3pxcq:last-child{font-weight:600}@media(max-width: 768px){main.svelte-v3pxcq.svelte-v3pxcq{right:var(--offsetX);bottom:var(--offsetY)}.chat.svelte-v3pxcq.svelte-v3pxcq{height:calc(100vh - var(--offsetY) - 100px);width:calc(100vw - var(--offsetX) - 16px)}.button.svelte-v3pxcq.svelte-v3pxcq{height:64px;width:64px}.button.svelte-v3pxcq img.svelte-v3pxcq{height:40px}.indicator.svelte-v3pxcq.svelte-v3pxcq{height:9px;width:9px;bottom:3.5px;right:3.5px;border:solid #3478ff 2.5px}.greeting.svelte-v3pxcq.svelte-v3pxcq{display:none;bottom:calc(var(--offsetY) + 3px);right:calc(var(--offsetX) + 72px)}}.footer.svelte-v3pxcq.svelte-v3pxcq{font-size:11.5px;color:#999999;text-align:center;width:100%;bottom:100px;margin:0px}.footer.svelte-v3pxcq a.svelte-v3pxcq{color:#3478ff;text-decoration:none}");
    }
    ...
    function create_if_block_3(ctx) {
    	...
    	return {
    		c() {
    			...
    			t6 = space();
    			p = element("p");
    			p.innerHTML = `Powered by <a href="https://pointai.tech" class="svelte-v3pxcq">PointAI</a>`;
    			attr(div0, "class", "avatar svelte-v3pxcq");
    			attr(div1, "class", "avatar-wrapper svelte-v3pxcq");
    			attr(div2, "class", "language-picker svelte-v3pxcq");
    			...
    			attr(div4, "class", "content svelte-v3pxcq");
    			attr(input, "type", "text");
    			attr(input, "placeholder", "Type here");
    			attr(input, "class", "svelte-v3pxcq");
    			attr(button, "type", "button");
    			attr(button, "class", "svelte-v3pxcq");
    			attr(div5, "class", "svelte-v3pxcq");
    			attr(p, "class", "footer svelte-v3pxcq");
    			attr(form, "class", "text-field svelte-v3pxcq");
    			attr(div6, "class", "chat shadow svelte-v3pxcq");
    		},
    		m(target, anchor) {
    ...
    // (190:5) {#if messages && messages.length !== 0}
    function create_if_block_7(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(p0, "class", "svelte-v3pxcq");
    			attr(p1, "class", "avatar-subtitle svelte-v3pxcq");
    			attr(div, "class", "avatar-title-closed svelte-v3pxcq");
    		},
    		m(target, anchor) {
    ...
    // (197:4) {#if !messages || messages.length === 0}
    function create_if_block_6(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(p0, "class", "title svelte-v3pxcq");
    			attr(p1, "class", "subtitle svelte-v3pxcq");
    		},
    		m(target, anchor) {
    ...
    function create_else_block_1(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.textContent = "🏳️";
    			attr(div, "class", "selected-language svelte-v3pxcq");
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    		},
    ...
    function create_if_block_5(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "selected-language svelte-v3pxcq");
    			attr(div1, "class", "language-select svelte-v3pxcq");
    		},
    		m(target, anchor) {
    ...
    // (215:7) {#each languages as language}
    function create_each_block_1(ctx) {
    	...
    	return {
    		c() {
    			...
    			t2 = text(t2_value);
    			t3 = space();
    			attr(div, "class", "language svelte-v3pxcq");
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    			append(div, t0);
    ...
    // (234:4) {#if messages && messages.length !== 0}
    ...
    // (236:5) {#each messages as message}
    ...
    function create_if_block_2(ctx) {
    	...
    	return {
    		c() {
    			...
    			div.innerHTML = `<p class="svelte-v3pxcq">Hey there!</p> 
			<p class="svelte-v3pxcq">How can I help?</p>`;

    			attr(div, "class", "greeting svelte-v3pxcq");
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    			current = true;
    ...
    function create_if_block_1(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			attr(div, "class", "indicator svelte-v3pxcq");
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    			current = true;
